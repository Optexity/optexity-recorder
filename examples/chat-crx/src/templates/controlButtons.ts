export const createControlButtons = (): string => `
  <div class="input-wrapper" style="display: flex; gap: 8px;">
    <button id="pauseButton" class="control-button pause-button" style="background: #4a5568; color: white; border: none; padding: 8px 16px; border-radius: 6px; display: flex; align-items: center; gap: 6px; cursor: pointer; transition: all 0.2s; opacity: 0.5; pointer-events: none;">
